...
public class TicTacToeDBHelper extends SQLiteOpenHelper {
    ...
    public TicTacToeDBHelper(Context context) {
        super(context, TicTacToeDBContract.DATA_BASE_NAME, null,
    ...
    public boolean ContainsMacAddress(String mac) {
        ...
        Cursor c = db.query(TicTacToeDBContract.BluetoothConnectionsEntry.TABLE_NAME,
            // The table to query
    ...
    public boolean SetPlayerName(String name, String mac) {
        ...
        //try to insert the row into the database, check for an error
        int rowsUpdated =
            db.update(TicTacToeDBContract.BluetoothConnectionsEntry.TABLE_NAME, values,
                rowUpdateClause, arguments);
