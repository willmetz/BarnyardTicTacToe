...
public class MyAlertDialogFragment extends DialogFragment {
   ...
   */
  public static MyAlertDialogFragment newInstance(int titleID, int buttonOneTitleID,
      int buttonTwoTitleID, String dialogMessage) {
  ...
  public Dialog onCreateDialog(Bundle SavedInstance) {
    ...
    try {
      positiveButtonTitle =
          getActivity().getResources().getString(getArguments().getInt(BUTTON_ONE_KEY));
    } catch (Resources.NotFoundException e) {
      positiveButtonTitle = DEFAULT_TITLE_BUTTON_ONE;
    }

    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(getActivity()).setTitle(title)
        .setMessage(getArguments().getString(DIALOG_MESSAGE_KEY));

    alertDialogBuilder.setPositiveButton(positiveButtonTitle,
        new DialogInterface.OnClickListener() {
          public void onClick(DialogInterface dialog, int which) {
            //alert the main activity to this
            ((FragmentAlertDialog) getActivity()).alertDialogButtonClick(
    ...
    if (buttonTwo != NO_BUTTON) {
      ...
      alertDialogBuilder.setNegativeButton(negativeButtonTitle,
          new DialogInterface.OnClickListener() {
