...
public class OnePlayerGame extends PlayGame implements Runnable {
  ...
  @Override public void InitGame() {
    ...
    _TheComputer = new ComputerPlayer(_MyGame, _PlayerTwo.GetPlayerID(), _PlayerOne.GetPlayerID(),
        _CellsInRow);
  ...
  public void run() {
    if ((_CurrentPlayer == _ComputerPlayer)
      ...
      _MyGame.MakeMove(myCell.GetCellRow(), myCell.GetCellColumn(), _CurrentPlayer.GetSymbolImage(),
