...
public abstract class PlayGame extends AppCompatActivity implements FragmentAlertDialog {
   ...
   */
  @Override public boolean onCreateOptionsMenu(Menu pMenu) {
   ...
   */
  @Override public void alertDialogButtonClick(int buttonNum) {
    switch (buttonNum) {
  ...
  @Override public boolean onOptionsItemSelected(MenuItem pItem) {
  ...
  @Override public boolean onPrepareOptionsMenu(Menu pMenu) {
    MenuItem item;
  ...
  public Cell BoardMove(int targetID) {
    ...
    moveAllowed = _MyGame.MakeMove(playerMoveRow, playerMoveCol, _CurrentPlayer.GetSymbolImage(),
  ...
  protected boolean gameOver() {
    ...
    _CurrentGameState = _MyGame.CheckGameResult(_PlayerOne.GetPlayerID(), _PlayerTwo.GetPlayerID());
    ...
    if (_CurrentGameState == GameState.Winner) {
      ...
      _gameOverDialog = MyAlertDialogFragment.newInstance(R.string.game_over_alert_dialog_title,
          R.string.game_over_button_one_title, R.string.game_over_button_two_title, msg);
  ...
  protected void updateWinCountMessages() {
    ...
    msg = _PlayerOne.GetName() + ": " + _PlayerOne.GetWinCount() + ((_PlayerOne.GetWinCount() == 1)
        ? " win" : " wins");
    ...
    msg = _PlayerTwo.GetName() + ": " + _PlayerTwo.GetWinCount() + ((_PlayerTwo.GetWinCount() == 1)
        ? " win" : " wins");
