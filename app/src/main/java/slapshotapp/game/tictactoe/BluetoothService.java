...
public class BluetoothService extends Service {
    ...
    private synchronized void setState(int inState) {
        ...
        if (_myHandler != null) {
            _myHandler.obtainMessage(MESSAGE_CONNECTION_STATE, inState, _myState, null)
                .sendToTarget();
        }
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                tmp = _myBTAdapter.listenUsingInsecureRfcommWithServiceRecord(NAME_OF_SERVICE,
                    MY_UUID);
            } catch (IOException e) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            if (_socket == null) {
                ...
                if (_myHandler != null) {
                    _myHandler.obtainMessage(MESSAGE_CONNECT_THREAD_FAIL, -1, -1, -1)
                        .sendToTarget();
                }
                return;
            }
    ...
    private class ConnectionManager extends Thread {
        ...
        public void run() {
            if (_MyWriter == null || _MyReader == null) {
                ...
                if (_myHandler != null) {
                    _myHandler.obtainMessage(MESSAGE_MANAGER_THREAD_FAIL, -1, -1, -1)
                        .sendToTarget();
                }
                return;
            }
            ...
            while (!_Exiting) {
                ...
                try {
                    ...
                    synchronized (BluetoothService.this) {
                        if (_myHandler != null) {
                            _myHandler.obtainMessage(MESSAGE_READ_FAILED, -1, -1, null)
                                .sendToTarget();
                        }
                    }
