...
public class SetUpGameBluetooth extends SetUpGame implements FragmentAlertDialog, ServiceConnection, OnCancelListener
{
    ...
    {
    	slapshotapp.game.support.BluetoothMessages baseMsg = new slapshotapp.game.support.BluetoothMessages(dataIn);
    	...
    	switch(baseMsg.getMessageID())
    	{
	    	...
	    	{	    		
	    		slapshotapp.game.support.BoardSizeMessage msg = new slapshotapp.game.support.BoardSizeMessage(dataIn);
	    	...
	    	{	    		
	    		slapshotapp.game.support.PlayerNameMessage msg = new slapshotapp.game.support.PlayerNameMessage(dataIn);
	    		...
	    		if(msg.GetPlayerName() != null){
	    			...
	    			if(!msg.GetPlayerName().contains(DEFAULT_PLAYER_NAME)){
			    		...
			    		_MyDBHelper.SetPlayerName(_PlayerTwo.GetName(), _myBluetoothService.getDeviceMac());
	    			}
	    	...
	    	{
	    		slapshotapp.game.support.PlayerImageMessage msg = new slapshotapp.game.support.PlayerImageMessage(dataIn);
	    	...
	    	{	    		
	    		slapshotapp.game.support.StartMessage msg = new slapshotapp.game.support.StartMessage(dataIn);
    ...
    protected void sendBluetoothMessage(short msgID)
    {
    	...
    	switch(msgID)
    	{
    		case BluetoothMessages.BOARD_SIZE_MESSAGE_ID:
    		{
    			slapshotapp.game.support.BoardSizeMessage msg = new slapshotapp.game.support.BoardSizeMessage();
    		...
    		case BluetoothMessages.PLAYER_NAME_MESSAGE_ID:
    		{
    			...
    			slapshotapp.game.support.PlayerNameMessage msg = new slapshotapp.game.support.PlayerNameMessage();
    		...
    		case BluetoothMessages.PLAYER_IMAGE_MESSAGE_ID:
    		{
    			slapshotapp.game.support.PlayerImageMessage msg = new slapshotapp.game.support.PlayerImageMessage();
    		...
    		case BluetoothMessages.START_GAME_MESSAGE_ID:
    		{
    			slapshotapp.game.support.StartMessage msg = new slapshotapp.game.support.StartMessage();
    			if(_AbortStart){
    				msg.Abort();
