...
public class BluetoothGame extends PlayGame implements ServiceConnection {
    ...
    @Override public void GameBoardClickListener(View target) {
    ...
    private void handleOtherPlayerMove(int col, int row) {
        ...
        if (_MyGame.IsMoveOnBoard(row, col)) {
            ...
            if (_MyGame.IsCellEmpty(row, col)) {
                ...
                _MyGame.MakeMove(row, col, _CurrentPlayer.GetSymbolImage(),
                ...
                Log.e("BluetoothGame",
                    "Received Invalid move message(Cell occupied) row = " + row + " col = " + col);
    ...
    private void processMessage(byte[] buffer) {
        ...
        switch (baseMsg.getMessageID()) {
            ...
            default:
                Log.e("BluetoothGame",
                    "Error unknown message id received: " + baseMsg.getMessageID());
                break;
        }
    }
