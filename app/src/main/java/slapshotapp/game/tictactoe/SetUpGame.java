...
public abstract class SetUpGame extends AppCompatActivity implements OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter =
            ArrayAdapter.createFromResource(this, R.array.GameModeSize,
    ...
    protected void setSpinnerDefaultLists() {
        //player one
        _PlayerOneSpinnerList =
            new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item);
        _PlayerOneSpinnerList.setDropDownViewResource(
            android.R.layout.simple_spinner_dropdown_item);
        _PlayerOneSpinner.setAdapter(_PlayerOneSpinnerList);
        _PlayerOneSpinner.setOnItemSelectedListener(this);

        //player two
        _PlayerTwoSpinnerList =
            new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item);
        _PlayerTwoSpinnerList.setDropDownViewResource(
            android.R.layout.simple_spinner_dropdown_item);
