...
{	
    ...
    @InjectView( R.id.PlayerOneSpinner )
    protected Spinner _PlayerOneSpinner;

    @InjectView( R.id.PlayerTwoSpinner )
    protected Spinner _PlayerTwoSpinner;

    @InjectView( R.id.gameBoardDimensionSpinner )
    protected Spinner _GameBoardModeSpinner;

    @InjectView( R.id.PlayerTwoName )
    protected  TextView _PlayerTwoName;

    @InjectView( R.id.PlayerOneName )
    protected TextView _PlayerOneName;

    @InjectView( R.id.PlayerTwoIconContainer )
    LinearLayout playerTwoIconContainer;
    ...
    void playerNameClicked( View view )
    {
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
		...
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(
	            this, R.array.GameModeSize, android.R.layout.simple_spinner_item);
    ...
    protected void setPlayerSoundEffect(String effectName, Player player)
    {
    	...
    	AssetFileDescriptor fd = getResources().openRawResourceFd(
    			_SymbolNameToSoundEffectHash.get(effectName));
