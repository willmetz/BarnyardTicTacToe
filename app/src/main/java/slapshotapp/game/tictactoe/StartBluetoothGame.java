...
public class StartBluetoothGame extends FragmentActivity
    ...
    private void scanForNearbyBluetoothDevices() {
        ...
        if (_myBluetoothAdapter.getScanMode()
    ...
    private void cancelConnection() {
        ...
        Toast.makeText(getApplicationContext(), R.string.cancel_connection_toast,
            Toast.LENGTH_SHORT).show();
    }
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if (_MyDBHelper.ContainsMacAddress(device.getAddress())) {
                    ...
                    if (!deviceAlreadyInList) {//add the device to the list
                        ...
                        _previouslyPlayedDevicesMapping.put(_previouslyPlayedDeviceCount,
                            device.getAddress());
